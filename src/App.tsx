...
import { Shield, Bitcoin, MapPin, Terminal, Lock, ChevronRight, Globe, Github } from 'lucide-react';
import { content } from './content';

type Language = 'de' | 'ru' | 'he';
type Page = 'home' | 'about' | 'links';
        ...
        <div className="max-w-6xl mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-3 mb-4 md:mb-0 cursor-pointer" onClick={() => setPage('home')}>
              <div className={`bg-sky-50 p-3 rounded-xl border border-sky-100 ${isRtl ? 'ml-3' : ''}`}>
